...
Invoke-WebRequest -Uri "https://s3.amazonaws.com/dl.ncsbe.gov/Elections/2024/Candidate%20Filing/Candidate_Listing_2024.csv" -OutFile "./candidate_data/Candidate_Listing_2024.csv"
